...
import requests
r = requests.get("http://www.nbcnewyork.com/weather/")
...
info = soup.find("div",class_ = "forecast-info").parent
#print(info)
temp = info.find(class_ = "temperature", id = "pwsTemp").text.strip()
print("The current temperature showing on the NBC New York weather page is %s."% temp)

# Answer to Question 2.2
condition = info.find(class_ = "condition").text.strip()
print("The current weather conditions are: %s." % condition)

# Answer to Question 2.3
humidity = info.find("span", id = "humidity").text.strip()
print("The current humidity level is %s." % humidity)